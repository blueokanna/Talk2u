...
Future<bool> cancelGeneration({required String conversationId}) => RustLib
    .instance
    .api
    .crateApiChatApiCancelGeneration(conversationId: conversationId);
...
}) => RustLib.instance.api.crateApiChatApiValidateApiKey(
